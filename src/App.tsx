...
const translations = {
  zh: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "爵士藝術家", slogan: "用靈魂的聲音，訴說每一個夜晚的故事。", disclaimer: <>本站為粉絲建立的非官方音樂典藏館，致力於收錄 Ponpon 音樂旅程中的媒體報導與演出紀錄。站內所有影音、照片版權均屬原權利人所有，本站僅作學術研究與非營利推廣使用。如有任何錯誤建議或版權疑慮，請來信：<a href="mailto:samlin0117@gmail.com" className="text-gold hover:text-gold-light transition-colors hover:underline">samlin0117@gmail.com</a>，我們將立即處理。</> },
  ...
  en: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "Jazz Artist", slogan: "Telling the stories of every night with a soulful voice.", disclaimer: <>An unofficial, fan-made archive dedicated to Ponpon's musical journey. We carefully curate her media coverage, radio interviews, and live performances, creating a cozy space for fans to linger and enjoy. For corrections or suggestions, please email: <a href="mailto:samlin0117@gmail.com" className="text-gold hover:text-gold-light transition-colors hover:underline">samlin0117@gmail.com</a></> },
  ...
  ja: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "ジャズアーティスト", slogan: "魂の歌声で、すべての夜の物語を語る。", disclaimer: <>ファンによって構築された非公式の音楽アーカイブです。国内外のメディア報道、ラジオインタビュー、ライブパフォーマンスなど、Ponponの音楽の旅の貴重な瞬間を丁寧に集めました。誤りやご提案がありましたら、<a href="mailto:samlin0117@gmail.com" className="text-gold hover:text-gold-light transition-colors hover:underline">samlin0117@gmail.com</a> までご連絡ください。</> },
...
const getTimelineData = (lang: Language) => {
  if (lang === 'en') {
    return [
      ...
      { year: "2015 - 2016", title: "Rising Star", desc: <>Won 2nd place at the <a href="https://news.ltn.com.tw/news/life/breakingnews/1327418" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">"City Star" singing contest</a> in 2015. In 2016, at just 14 years old, she won the <a href="https://www.chinatimes.com/newspapers/20160824000626-260507?chdtv" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">Entertainment Group Championship of the 5th "Eelin Star"</a>. <a href="https://www.youtube.com/watch?v=D4eou5cff68" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ Watch highlights</a></> },
      { year: "2018 - 2019", title: "Overseas Duet & Landmark Contest", desc: <>Performed on the popular TV show <a href="https://star.ettoday.net/news/1164745" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">"Come Sing with Me 3"</a> in 2018, singing a solo duet with Wang Yuan. <a href="https://www.youtube.com/watch?v=JNy94_bUgx0&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=24" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ Watch highlights</a><br/><br/>In 2019, she competed as a challenger in Taiwan's iconic music survival show <strong>"Jungle Voice"</strong>. <a href="https://www.youtube.com/watch?v=5lPml-yAc2I&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=25" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ Watch highlights</a></> },
      ...
      { year: "2025", title: "Global Recognition & Master Collaborations", desc: <>In May, she was invited to perform a rearranged outro for <strong>ABC News</strong> "World News Now", with the video surpassing a million views. <a href="https://www.youtube.com/watch?v=1Fnnr4TOjVQ&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=5" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ Watch performance</a><br/><br/>At the end of the year, she was invited to an annual L.A. grand event to perform alongside Grammy winner Randy Waldman. <a href="https://www.youtube.com/watch?v=HCUE2cDCOqs&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=1" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ Watch performance</a></> },
  ...
  if (lang === 'ja') {
    return [
      ...
      { year: "2015 - 2016", title: "注目の新星", desc: <>2015年の<a href="https://news.ltn.com.tw/news/life/breakingnews/1327418" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">歌唱コンテストで2位を獲得</a>。2016年、わずか14歳で第5回<a href="https://www.chinatimes.com/newspapers/20160824000626-260507?chdtv" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">「イーリン・スター」エンターテインメント部門で優勝</a>。<a href="https://www.youtube.com/watch?v=D4eou5cff68" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 演出ハイライトを観る</a></> },
      { year: "2018 - 2019", title: "海外での挑戦と飛躍", desc: <>2018年に人気音楽番組<a href="https://star.ettoday.net/news/1164745" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">「Come Sing with Me 3」に出演</a>し、人気歌手ワン・ユエンとデュエット。<a href="https://www.youtube.com/watch?v=JNy94_bUgx0&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=24" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 演出ハイライトを観る</a><br/><br/>2019年には台湾を代表するオーディション番組<strong>「Jungle Voice」</strong>にチャレンジャーとして参戦。<a href="https://www.youtube.com/watch?v=5lPml-yAc2I&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=25" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 演出ハイライトを観る</a></> },
      ...
      { year: "2025", title: "国際メディア掲載と巨匠との共演", desc: <>5月、米国<strong>ABC News</strong>「World News Now」のエンディング曲アレンジと演奏に招待され、動画は100万回再生を突破。<a href="https://www.youtube.com/watch?v=1Fnnr4TOjVQ&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=5" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 演出を観る</a><br/><br/>年末にはロサンゼルスの年末恒例行事に招かれ、グラミー賞受賞者Randy Waldmanと共演を果たす。<a href="https://www.youtube.com/watch?v=HCUE2cDCOqs&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=1" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 演出を観る</a></> },
  ...
  return [
    ...
    { year: "2015 - 2016", title: "初試啼聲與耀眼新星", desc: <>2015年獲得<a href="https://news.ltn.com.tw/news/life/breakingnews/1327418" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">「城市之星」歌唱比賽第二名</a>；2016年以14歲之姿奪得第5屆<a href="https://www.chinatimes.com/newspapers/20160824000626-260507?chdtv" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">「伊林璀璨之星」演藝組冠軍</a>。<a href="https://www.youtube.com/watch?v=D4eou5cff68" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 點此觀看演出精華</a></> },
    { year: "2018 - 2019", title: "跨海登台與指標定錨", desc: <>2018年赴湖南衛視參與<a href="https://star.ettoday.net/news/1164745" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors">《我想和你唱3》</a>，獲選與王源單獨合唱《驕傲》。<a href="https://www.youtube.com/watch?v=JNy94_bUgx0&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=24" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 點此觀看演出精華</a><br/><br/>2019年擔任台灣指標性音樂節目<strong>《聲林之王》</strong>第二季踢館歌手，演唱《台北某個地方》。<a href="https://www.youtube.com/watch?v=5lPml-yAc2I&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=25" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 點此觀看演出精華</a></> },
    ...
    { year: "2025", title: "躍上國際媒體與大師結緣", desc: <>5月受邀為美國 <strong>ABC News</strong>《World News Now》演出改編片尾曲，影片突破百萬點閱。<a href="https://www.youtube.com/watch?v=1Fnnr4TOjVQ&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=5" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 點此觀看演出精華</a><br/><br/>年底受邀洛杉磯年度盛事，與葛萊美得主 Randy Waldman 同台演出。<a href="https://www.youtube.com/watch?v=HCUE2cDCOqs&list=PLLwWHVIUlB8lzbav-7ETbHfJhDqZDOkJj&index=1" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light hover:underline transition-colors whitespace-nowrap ml-1">➜ 點此觀看演出精華</a></> },
