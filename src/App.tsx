...
const translations = {
  zh: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "爵士藝術家", slogan: "用靈魂的聲音，訴說每一個夜晚的故事。", disclaimer: <>本站為粉絲建立的非官方音樂典藏館。我們悉心收錄 Ponpon 音樂旅程中的國內外媒體報導、廣播專訪與現場演出，讓同好們能隨時駐足，自在回味那些觸動靈魂的聲音與點滴。如有內容錯誤或建議，請來信至：<a href="mailto:samlin0117@gmail.com" className="text-gold hover:text-gold-light transition-colors hover:underline">samlin0117@gmail.com</a></> },
