...
const translations = {
  zh: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "爵士歌手", slogan: "用靈魂的聲音，訴說每一個夜晚的故事。" },
  ...
  en: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "Jazz Vocalist", slogan: "Telling the stories of every night with a soulful voice." },
  ...
  ja: {
    ...
    hero: { title: "Ponpon Chen", subtitle: "ジャズボーカリスト", slogan: "魂の歌声で、すべての夜の物語を語る。" },
