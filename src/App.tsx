...
const translations = {
  zh: {
    ...
    interview: { title: "廣播訪問", description: "收聽 Ponpon 的最新專訪，深入了解她的音樂旅程。", rti1: "音樂本事 旅美爵士新星陳芃瑄 — 尋找靈魂深處的原創聲音（上）", rti2: "音樂本事 旅美爵士新星陳芃瑄 — 尋找靈魂深處的原創聲音（下）", rti1Date: "2026-03-16", rti2Date: "2026-03-23", pod1: "中廣流行網 Midnight You & Me - 專訪：陳芃瑄", pod1Date: "2026-03-08", podSource: "中廣流行網", pod2: "台灣爵士樂歌手陳芃瑄 PonPon Chen 歌聲唱響 ABC 新聞", pod2Date: "2025-10-07", pod2Source: "快樂方程式", listenNow: "點擊前往收聽" },
  ...
  en: {
    ...
    interview: { title: "Radio Interview", description: "Listen to Ponpon's latest interview and dive deep into her musical journey.", rti1: "Music Essence: Rising Jazz Star Ponpon Chen - Finding the Original Voice (Part 1)", rti2: "Music Essence: Rising Jazz Star Ponpon Chen - Finding the Original Voice (Part 2)", rti1Date: "2026-03-16", rti2Date: "2026-03-23", pod1: "BCC Midnight You & Me - Interview: Ponpon Chen", pod1Date: "2026-03-08", podSource: "BCC Radio", pod2: "Taiwanese Jazz Singer Ponpon Chen's Voice Shines on ABC News", pod2Date: "2025-10-07", pod2Source: "Happy Equation", listenNow: "Listen Now" },
  ...
  ja: {
    ...
    interview: { title: "ラジオインタビュー", description: "Ponponの最新インタビューを聴いて、彼女の音楽の旅を深く知ろう。", rti1: "音楽の真髄：米国の新星ジャズシンガー Ponpon Chen - 魂の奥底にあるオリジナルな声を探して (前編)", rti2: "音楽の真髄：米国の新星ジャズシンガー Ponpon Chen - 魂の奥底にあるオリジナルな声を探して (後編)", rti1Date: "2026-03-16", rti2Date: "2026-03-23", pod1: "BCC Midnight You & Me - インタビュー: Ponpon Chen", pod1Date: "2026-03-08", podSource: "BCCラジオ", pod2: "台湾のジャズシンガー Ponpon Chenの歌声がABCニュースで輝く", pod2Date: "2025-10-07", pod2Source: "Happy Equation", listenNow: "今すぐ聴く" },
